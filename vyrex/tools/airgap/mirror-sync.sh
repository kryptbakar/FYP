...
V_NUCLEI=vyrex_nuclei_templates
V_TRIVY=vyrex_trivy_cache
V_SIGMA=vyrex_sigma_rules
V_SURICATA=vyrex_suricata_rules
NET=vyrex_egress     # the dual-homed egress network from the airgap overlay
