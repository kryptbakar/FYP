...
const ROUTES = {
  ...
  investigations: { title: 'Investigations', crumb: 'Evidence-grounded LangGraph investigations', icon: 'model', key: '', sec: 'Operate', view: viewInvestigations },
  agent:      { title: 'AI Analyst', crumb: 'Agentic triage — self-hosted LLM (deprecated: see Investigations)', icon: 'model', key: '', sec: 'Operate', view: viewAgent },
  automation: { title: 'Automation', crumb: 'n8n engine — status & workflows', icon: 'activity', key: '', sec: 'Operate', view: viewAutomation },
  defense:    { title: 'Autonomous Defense', crumb: 'Sentinel · Decoy · Mend · Forge — agentic active defense', icon: 'shieldcheck', key: '', sec: 'Operate', view: viewAutonomous },
